...
Blockly.PHP.lists_split = function (a) {
  ...
  if ("SPLIT" == a) b || (b = "''"), a = "explode"; else if ("JOIN" == a) b || (b = "array()"), a = "implode"; else throw"Unknown mode: " + a;
...
Blockly.PHP.controls_for = function (a) {
  var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE),
    ...
    e = Blockly.PHP.valueToCode(a, "BY", Blockly.PHP.ORDER_ASSIGNMENT) || "1", g = Blockly.PHP.statementToCode(a, "DO");
...
Blockly.PHP.procedures_defreturn = function (a) {
  ...
  Blockly.PHP.STATEMENT_PREFIX && (e = a.id.replace(/\$/g, "$$$$"), c = Blockly.PHP.prefixLines(Blockly.PHP.STATEMENT_PREFIX.replace(/%1/g, "'" +
    e + "'"), Blockly.PHP.INDENT) + c);
  ...
  g && (g = "  return " + g + ";\n");
  var f = [];
  for (e = 0; e < a.arguments_.length; e++) f[e] = Blockly.PHP.variableDB_.getName(a.arguments_[e], Blockly.Variables.NAME_TYPE);
  b = "function " + d + "(" + f.join(", ") + ") {\n" + b + c + g + "}";
...
Blockly.PHP.text_indexOf = function (a) {
  ...
  if (a.workspace.options.oneBasedIndex) var e = " 0", g = " + 1"; else e = " -1", g = "";
...
Blockly.PHP.text_getSubstring = function (a) {
  var b = Blockly.PHP.valueToCode(a, "STRING", Blockly.PHP.ORDER_FUNCTION_CALL) || "''", c = a.getFieldValue("WHERE1"),
    d = a.getFieldValue("WHERE2");
  if ("FIRST" != c || "LAST" != d) {
    var e = Blockly.PHP.getAdjusted(a, "AT1");
